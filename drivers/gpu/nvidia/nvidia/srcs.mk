...
# gcc_helper.c is intentionally NOT built: it defines module-local memcpy/memset
# wrappers around os_mem_copy/os_mem_set, while os_mem_copy/os_mem_set fall back
# to memcpy/memset themselves -> infinite recursion, kernel stack overflow in
# nvidia_init_module. The kernel exports memcpy/memset (lib/string.c), which is
# exactly what the os_mem_copy fallback comment asks for; the arm64
# vmalloc/ioremap WAR remains in os_mem_copy/os_mem_set itself.
...
SRCS += src/kernel/gpu/arch/t25x/kern_gpu_t256d.c
